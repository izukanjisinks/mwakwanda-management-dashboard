...
const org = ref({ name: '', email: '', phone: '', address: '', logo_url: '' })
...
function reset() {
  ...
  step.value = 1
  org.value = { name: '', email: '', phone: '', address: '', logo_url: '' }
      ...
      <div class="rounded-xl border bg-card overflow-hidden">
        <div class="px-6 py-4 border-b">
          ...
          <p class="text-sm text-muted-foreground mt-0.5">
            {{ step === 1
              ? 'Enter the core identity details for the new organisation.'
        ...
        <div class="p-6">
          ...
          <div v-if="step === 1" class="flex flex-col gap-4">
            <div class="grid gap-2">
              ...
              <Input id="org_name" v-model="org.name" placeholder="e.g. Serengeti Heights Resorts" />
            </div>
            <div class="grid gap-2">
            ...
            <div class="grid grid-cols-2 gap-4">
              <div class="grid gap-2">
                ...
                <Input id="org_phone" v-model="org.phone" type="tel" placeholder="+1 555 000 0000" />
              </div>
              <div class="grid gap-2">
            ...
            <div class="grid gap-2">
              ...
              <Input id="org_address" v-model="org.address" placeholder="123 Main Street, Suite 400" />
            </div>
          </div>
